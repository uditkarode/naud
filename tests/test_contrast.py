...
TAIL = [
    ...
    ("The fix is architectural, not cosmetic.", "The fix is architectural `(not: cosmetic)`."),
    ...
    ("I checked the logs rather than assuming.", "I checked the logs."),
    ("It's a problem, not a theoretical one.", "It's a problem."),
